...
const Hero = () => {
  return (
    <div className="hero -mt-[16px]">
      <div className="hero-content text-center">
        <div>
          <h1 className="text-5xl font-bold">
            Welcome to{" "}
            <span className="text-5xl bg-300% font-bold bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text animate-gradient">
              ByteBlaze
            </span>
          </h1>
          ...
          <div className="flex gap-2 justify-center">
            <Link to="/read-blogs" className="relative inline-block px-4 py-2 font-medium group">
